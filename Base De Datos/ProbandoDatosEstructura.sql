...
CREATE TABLE contenido (
    ...
    num_semana_anual integer,
    num_sem_semestral integer,
...
INSERT INTO contenido VALUES (8, 1, 1, '2013-12-04', '2013-12-05', '1', '0', 'asdfr', 'asde', 1);
INSERT INTO contenido VALUES (10, 1, 1, '2013-12-23', '2013-12-31', '1', '0', '1', '1', 1);
INSERT INTO contenido VALUES (11, 2, 2, '2013-12-18', '2013-12-31', '2', '0', 'Hola', '|ASD', 1);
...
SELECT pg_catalog.setval('contenido_id_contenido_seq', 11, true);
...
SELECT pg_catalog.setval('paises_pk_seq', 28, true);
...
INSERT INTO planificacion VALUES (8, '11.111.111-1', 2, 1, 1, 'asd', 'INF-635', 2, '2013-12-19', 'asd', 21030);
...
SELECT pg_catalog.setval('planificacion_cod_clasificacion_seq', 8, true);
...
--
-- Name: contenido_cod_clasificacion_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY contenido
    ADD CONSTRAINT contenido_cod_clasificacion_fkey FOREIGN KEY (cod_clasificacion) REFERENCES planificacion(cod_clasificacion) ON UPDATE RESTRICT ON DELETE RESTRICT;
